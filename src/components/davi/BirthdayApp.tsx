...
export default function BirthdayApp() {
  ...
  <p>30 de setembro · 19h · Petisco da Praça</p>
  <Button type="button" onClick={share}><Share2 /> Espalhe a convocação</Button>
  <div className="cyber-badge-footer" style={{ marginTop: "1rem", fontSize: "0.85rem", opacity: 0.8 }}>
    Desenvolvido por <a href="https://seu-site.com" target="_blank" rel="noopener noreferrer" style={{ color: "cyan", textDecoration: "underline" }}>Prof. Anderson</a> • Powered by Gemini
  </div>
</footer>
